...
The goal here would be to see how what kind of a difference there would be in training with a single-task, multi-task, and a typical multi-label model with a data set containing overlapping classes.

\section{Object detection with image classification}
Okay coolio


\section{Object detection classification and segmentation}
Train cool stuff
