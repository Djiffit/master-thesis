...
To further extend the generalizability, we will try to add a third somewhat similar classification task using the Oxford flowers dataset \citep{flowers102}, which contains 102 different flower species.
