...
For each class $i$, we will calculate the proportion of its score with respect to the sum of all the classes' scores, creating the probability distribution.
...
\[{CE(y) = -\frac{1}{N}\sum_{i=1}^{N}(y_i * log(p_i) + ( 1 - y_i ) * log ( 1 - p_i))}\] \noindent
